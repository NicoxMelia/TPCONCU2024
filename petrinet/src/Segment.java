            ...
            for (Transition transition : transitions) {
                if (transition.getIsWaiting()) {
                    ...
                    if (transition.getDelayTime() <= System.currentTimeMillis() && transition.canFire()) {
                        ...
                        // Check policy to decide if the transition should fire
                        if (Policy.shouldFireTransition(transition.getTransitionId())) {
                            ...
                            Policy.incrementTransitionCounter(transition.getTransitionId());
